...
module.exports = (sequelize) => {
  const Student = sequelize.define(
    "Student",
    {
      ...
      placement_cell_id: {
        // Added missing placement_cell_id field
        type: DataTypes.UUID,
        references: {
    ...
    },
    {
      ...
      paranoid: true, // This tells Sequelize to use `deleted_at` for soft delete
      deletedAt: "deleted_at", // Explicitly set the soft delete column
    }
  );
